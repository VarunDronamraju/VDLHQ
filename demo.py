...
def main():
    ...
    inquiry_payload = {
        "client": {"name": "Demo Studio Productions", "email": "demo@example.com", "phone": "+1234567890"},
    ...
    if pipeline_resp.status_code == 200:
        ...
        demo_lead = next((lead for lead in pipeline_data if lead["id"] == lead_id), None)
        if demo_lead:
    ...
    transition_payload = {"new_state": "booked", "actor": "demo_ops_user", "reason": "Demo workflow transition to booked."}
